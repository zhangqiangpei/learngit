...
var tableAttr = getTableFieldMergeAttr({
    ...
    methods: {
        ...
        psdTableResetCondition : function(){
        	...
        	this.tableSearchModel.MetadataId = null;
        	this.ctDbMetadataName = null;
        },
        /*//添加条件
        ...
        changeClick : function(){
        	commonVue.CtDbMetadataListCallBack = this.changeClickCallback;
			ak.dialog("CtWsMetadataList","common/CtDbMetadataList.html");
        },
        //目录选择器回调事件
        changeClickCallback : function(data){
        	//处理参数
        	this.ctDbMetadataName = data.db_metadata_name;
