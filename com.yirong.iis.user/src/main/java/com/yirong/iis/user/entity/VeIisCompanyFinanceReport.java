...
/**
 * 
 * @ClassName: VeIisCompanyFinanceReport  
 * @Description: TODO(公司财务视图entity类) 
 * @author liny
 * @date 2017年11月28日 下午7:41:15 
 * @version V0.1
 */
@Entity
@Table(name="VE_IIS_COMPANY_FINANCE_REPORT")
public class VeIisCompanyFinanceReport extends IdEntity{
