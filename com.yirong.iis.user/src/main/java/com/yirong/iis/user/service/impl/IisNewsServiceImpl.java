...
public class IisNewsServiceImpl extends BaseService<IisNews, String>
	...
	public Map queryIisNewsCompanyList(IisNewsUserEntity ue) {
		...
		sql.append("SELECT N.ID,N.TITLE,N.TITLE_EN,N.TITLE_CHN,N.SOURCE,N.COMPANY_NAME,N.COUNTRY_ENG_NAME,N.COUNTRY_CHN_NAME,TO_CHAR(N.CREATE_TIME,'YYYY-MM-DD HH24:MI:SS') AS CREATE_TIME");
		sql.append("  FROM IIS_NEWS N, IIS_COMPANY  C WHERE N.COMPANY_ID = C.COMPANY_ID  AND C.Type='025001' ORDER BY N.CREATE_TIME DESC");
