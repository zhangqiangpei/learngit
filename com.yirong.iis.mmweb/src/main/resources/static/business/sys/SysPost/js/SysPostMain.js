...
var tableAttr = getTableMergeAttr({
    ...
    methods: {
        ...
        //新增按钮
        addClick: function () {
    		ak.dialog("save","business/sys/SysPost/SysPostSave.html");
        },
        //删除按钮
        delClick : function(){
        	//获取表格选中的id集
        ...
        delSerivce : function(ids){
        	var result = ak.msService("sys","sysPostApi/delete",{ids : ids});
        ...
        handleEdit: function(index,row){
        	...
        	ak.dialog("update","business/sys/SysPost/SysPostUpdate.html");
        },
...
var mainAttr = {
    ...
    mounted: function () {
    	//初始化table
    	this.tableInit("sys","sysPostApi/queryList");
   	    //查询后台
    	this.onSearch();
    } 
};
