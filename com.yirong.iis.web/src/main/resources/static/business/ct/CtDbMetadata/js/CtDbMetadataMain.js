...
var tableAttr = getTableMergeAttr({
    ...
    methods: {
    	loadData : function(){
    		this.selectInit("ct");
        	this.dbMetadataTypes = this.selectSearch("012");
        	this.fieldTypes=this.selectSearch("018");
        ...
        //新增按钮
        addClick: function () {
    		ak.dialog("save","business/ct/CtDbMetadata/CtDbMetadataSave.html");
        },
        //修改按钮
        updateClick : function(){
        	...
        	if(ids.length != 1){
        		...
        		ak.dialog("update","business/ct/CtDbMetadata/CtDbMetadataUpdate.html");
        	}
        },
        //删除按钮
        delClick : function(){
        ...
        delCallback : function(instance){
        	...
        	//请求后台
        	var result = ak.msService("ct","CtDbMetadataApi/delete",{ ids : idsStr});
